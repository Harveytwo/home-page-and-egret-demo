 ...
 */
class MoveUtil extends egret.Sprite {
  private _startPos: egret.Point = new egret.Point(0, 0); //默认起点位置
  // private _endPos: egret.Point = new egret.Point(0, Data.stageH);//默认终点位置
  private _endPos: egret.Point = new egret.Point(0, common.curHeight());//默认终点位置
  public _speedY: number = Data.startSpeed;
  private _startSpeedY: number = Data.startSpeed;//初始速度
  ...
  public onEnterFrame() {
    ...
    //设置速度上限
    if (this._speedY >= Data.mostSpeed) {
      this._speedY = Data.mostSpeed;
    }
